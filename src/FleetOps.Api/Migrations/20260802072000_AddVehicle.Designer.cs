...
namespace FleetOps.Api.Migrations
{
    ...
    [Migration("20260802072000_AddVehicle")]
            ...
            modelBuilder.Entity("FleetOps.Api.Domain.Entities.Driver", b =>
                {
                    ...
                    b.HasKey("Id");
                    b.HasIndex("DriverLicenseNumber").IsUnique();
            ...
            modelBuilder.Entity("FleetOps.Api.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<string>("LastName").IsRequired().HasMaxLength(200).HasColumnType("nvarchar(200)");
                    b.Property<string>("Name").IsRequired().HasMaxLength(100).HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("FleetOps.Api.Domain.Entities.Vehicle", b =>
                {
                    ...
                    b.Property<string>("PlateNumber").IsRequired().HasMaxLength(20).HasColumnType("nvarchar(20)");
                    b.Property<int>("Status").ValueGeneratedOnAdd().HasColumnType("int").HasDefaultValue(1);
                    b.Property<string>("Vin").IsRequired().HasMaxLength(50).HasColumnType("nvarchar(50)");
                    b.Property<int>("Year").HasColumnType("int");
                    b.HasKey("Id");
                    b.HasIndex("PlateNumber").IsUnique();
                    b.HasIndex("Vin").IsUnique();
